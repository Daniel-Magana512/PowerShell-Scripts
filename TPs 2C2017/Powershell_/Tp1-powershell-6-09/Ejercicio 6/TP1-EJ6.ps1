...
$val2=$val1.length
    ...
    elseif($val2 -gt 1)
    {
    write-host "TIENE VALORES NO NUMERICOS "
    }
    else
    {
...
<#
.SYNOPSIS
Nombre del script: TP1-EJ6-6_9_2017.ps1
...
muestra matriz y la clasifica, si el archivo tine valores no numericos lo indica y termina sin hacer ninguna operacion, por defecto el 
...
.EXAMPLE
si ejecuta ./TP1-EJ6-28_8_2017 archivo separador -escalar num
...
.OUTPUTS
Devuelve mensajes que indcan el tipo de matriz, o si hubo un error 
